...
struct SettingView: View {
    ...
    private func customSegmentStyle() {
        ...
        UISegmentedControl.appearance().setTitleTextAttributes([NSAttributedString.Key.foregroundColor:UIColor(Color.yellow)], for: .selected)
